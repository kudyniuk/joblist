                ...
                >
                    ...
                    >
                        <Box sx={{ gap: 2, display: 'flex', alignItems: 'center' }}>
                            ...
                            <Typography level="title-lg">Job List</Typography>
                        </Box>
                        <ColorSchemeToggle />
                    </Box>
                    <Box
                    ...
                    >
                        <Stack gap={4} sx={{ mb: 2 }}>
                            ...
                            <Button
                                ...
                                color="neutral"
                                fullWidth
                                startDecorator={isLoading ? null : <GoogleIcon />}
                            ...
                            <form>
                                ...
                                <Stack gap={4} sx={{ mt: 2 }}>
                                    ...
                                    >
                                        ...
                                        <Link level="title-sm" href="#link_forgot_your_password">
