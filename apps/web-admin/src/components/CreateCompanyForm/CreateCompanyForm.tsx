...
import { useGetUserCompanyQuery, useUpdateUserCompanyMutation } from "../../store"
...
export const Form: React.FC<{ defaultValues?: FormValues }> = ({ defaultValues }) => {
    ...
    return <form onSubmit={handleSubmit(onSubmit)}>
        <Stack spacing={1}>
            ...
            <Input placeholder="Company Address" required {...register("address")} />
            <Button type="submit" loading={result.isLoading}>Save</Button>
        </Stack>
    </form>
}